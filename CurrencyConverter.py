...
headlabel = tk.Label(Tops, font=('lato black', 19, 'bold' ), text=' Welcome to Real Time Currency converter ',bg='#E21531', fg='black')
headlabel.grid(row=3, column=1, sticky=W)
...
Label_9 = Button(root, font=('arial', 15, 'bold'), text=" Convert ", padx=2, pady=2, bg="#15D4E2", fg="white",command=RealTimeCurrencyConversion)
Label_9.grid(row=6, column=0)

Label_1 = Label(root, font=('lato black', 7, 'bold'), text="", padx=2, pady=2, bg="#e6e5e5", fg="black")
Label_1.grid(row=9, column=0, sticky=W)

Label_9 = Button(root, font=('arial', 15, 'bold'), text=" Clear All ", padx=2, pady=2, bg="#15D4E2", fg="white",command=clear_all)
...
if __name__ == "__main__":
    ...
    ACCESS_KEY = 'RDwuEcdIHsRHtVGz4y1NXiKVbWn9uRR8'
